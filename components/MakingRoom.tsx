...
export const MakingRoom: React.FC<MakingRoomProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-blue-50 flex flex-col items-center justify-center px-6 pt-32 relative overflow-hidden">
      {/* Background Elements */}
